...
namespace sofacv
{
    ...
    void FemurConstraintForce::doUpdate()
    {
        ...
        if (d_deformableRegi.getValue())
        {
            ...
            Real xForce = forceX * 5 * forceWeightPercentage1 * forceWeight;
            Real yForce = forceY * 5 * forceWeightPercentage1 * forceWeight;
            Real zForce = forceZ * 5 * forceWeightPercentage1 * forceWeight;

            Real xForce2 = -forceX * 10 * forceWeightPercentage1 * forceWeight;
            Real yForce2 = -forceY * 10 * forceWeightPercentage1 * forceWeight;
            Real zForce2 = -forceZ * 10 * forceWeightPercentage1 * forceWeight;
